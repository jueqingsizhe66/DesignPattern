...
public class CatPreparedStatement implements PreparedStatement {

    private PreparedStatement ps;
    private String sql;
    public CatPreparedStatement(PreparedStatement ps, String sql) {
        this.ps =ps;
        this.sql =sql;
    }
    ...
    public void setObject(int parameterIndex, Object x, int targetSqlType, int scaleOrLength) throws SQLException {
        ps.setObject(parameterIndex,targetSqlType,scaleOrLength);
    }
